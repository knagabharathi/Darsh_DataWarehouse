...
SELECT t1.* FROM OUR_FIRST_DB.public.test t1
CROSS JOIN (SELECT * FROM OUR_FIRST_DB.public.test) t2;
...
// Create permanent table inside the transient schema - it will auto created as Transient table only
